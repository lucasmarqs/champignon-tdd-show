...
RSpec.describe Blogs::PostsController, :type => :controller do
  ...
  describe 'the index method for posts controller' do

    it 'should return http success on index' do
      get :index
    ...
    context "when rendering views" do
      ...
      it "should render template without collection data" do
        get :index
        expect(response).to render_template(:index)
      end

      it "should render template with collection data" do
        @user = User.create(
